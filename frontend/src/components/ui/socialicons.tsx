    ...
    <StyledWrapper>
      <ul className="example-2">
        <li className="icon-content">
          <a href="mailto:shoaib@filmfluence.in" aria-label="GitHub" data-social="github">
...
>
  ...
  <path d="M0 4.697v7.104l5.803-3.477L0 4.697zM6.761 8.83l-6.528 3.91A2 2 0 0 0 2 14h12a2 2 0 0 0 1.767-1.26l-6.528-3.91L8 9.586l-1.239-.757zM10.197 8.324 16 11.801V4.697l-5.803 3.627z" />
        ...
        <li className="icon-content">
          <a href="https://www.instagram.com/filmfluenceindia" target='_blank' aria-label="Instagram" data-social="instagram">
            <div className="filled" />
